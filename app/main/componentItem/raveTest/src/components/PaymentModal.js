...
import {
  ...
  selAuthUrl,
  selTxnRef,
  selPaymentTypeTxnMessage,
  selFormTypeFields,
  selValidationBtnLabel,
  selTransaction,
  selValRespAction,
  selUserToken,
  selValDetails,
...
class PaymentModal extends Component {
  ...
  _handleNavChange = url => {
    ...
    const transactionMsg =
      isComplete && isRememberMe(chkGrpValue)
        ...
        {tabs.map(tab => {
          ...
          return (
            <Text
              ...
              <Icon
                name={`${tab === CARD ? 'credit-card-alt' : 'university'}`}
              />
              &emsp;{tab}
            </Text>
          );
      ...
      <View>
        <Section>
          <Input
            ...
            value={accountnumber}
            onChangeText={this._handleAccountDetails.bind(
              this,
              'accountnumber',
            )}
          />
        ...
        <Section>
          <Select
            ...
            changeValue={this._handleAccountDetails.bind(
              this,
              'validateoption',
            )}
          />
    ...
    return (
      <View style={[styles.parentSection, styles.paymentForm]}>
        <View style={styles.sectionContainer}>
          ...
          {transactionMsg ? this.renderInfoContent() : this.renderContent()}
        </View>
      </View>
    );
  }
