...
export default class index extends Component {
    ...
    render() {
        ...
        closeIcon = <Icon name='md-close-circle' style={{ color: '#3045C2', marginTop: 0, marginRight: 0 }} />;
        return (
            <KeyboardAvoidingView behavior="padding" enabled>
                <KeyboardAwareScrollView style={styles.container} keyboardShouldPersistTaps='always'>
                    <View style={{ flex: 1 }}>
                        ...
                        <View style={{ borderBottomWidth: 4, marginTop: 30, marginRight: '50%', borderBottomColor: '#3045C2' }}></View>
                    </View>
