...
class Chat extends React.Component {
  ...
  render() {
    var leftHeaderBtn = this.getLeftHeaderBtn();
    var rightHeaderBtn = this.getRightHeaderBtn();
    console.log('-- render chatHeight: ', this.state.chatHeight)
    return (
      <Container style={styles.container}>
        <GiftedChat
          ...
          style={{ height: this.state.chatHeight }}
        />
