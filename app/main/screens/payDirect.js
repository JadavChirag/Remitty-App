...
export default class currencyWithdraw extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            r_amount: 0.00,
            selectedIndex: 0,
            currency: this.props.navigation.getParam('currency', 'BTC'),
            rate: '0.0',
            balance:0,
            showme:true,
            curprice:0,
        ...
        return (
            <View style={styles.container}>
            {
                ...
                <Content style={{ width: '100%' }}>
                    ...
                    <Text style={[styles.title, { marginTop: 25 }]}>Pay {this.state.currency} </Text>
                  ...
                  <TouchableHighlight
                    onPress={() => {this.onButtonPressed();}} style={{alignItems: 'center',marginTop:2}}> 
                    ...
                    <Text style={{ fontSize:10,marginLeft:40,marginTop:5 }}>Estimated balance : {parseFloat((this.state.balance*this.state.curprice)-(this.state.r_amount*this.state.curprice)).toFixed(2)+' USD'}  </Text>
                    </View>
