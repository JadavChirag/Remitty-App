                            ...
                            <ScrollView >
                                <View style={styles.container}>
                                    <TextIconButton
                                        textTitle="USD"
                                        textSub="USD"
                                        textNumber="Deposite Request"
                                        icon={usdicon}
                                        onPress={() => this.props.navigation.navigate('depositRequestForm', { currency: "USD" })}
                                    />
                                    <TextIconButton
                                        textTitle="EUR"
                                        textSub="EUR"
                                        textNumber="Deposite Request"
                                        icon={euricon}
                                        onPress={() => this.props.navigation.navigate('depositRequestForm', { currency: "EUR" })}
                                    />
                                </View>
                            </ScrollView>
