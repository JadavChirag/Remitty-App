...
export default class CashoutPayoneerScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            operators: operators,
        ...
        return (
            <View style={styles.container}>
                <Content style={{ width: '100%' }}>
                    <Text style={[styles.title, { marginTop: 20, textAlign: 'left', marginLeft: 30, }]}>Payoneer</Text>
                    ...
                    <Text style={[styles.txtsub, { marginTop: 20, textAlign: 'left', marginLeft: 30, }]}>Payoneer ID</Text>
                    <TextInput
                        style={{
                            borderRadius: 5,
                            borderWidth: 1,
