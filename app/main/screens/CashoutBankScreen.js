...
export default class CashoutBankScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            operators: operators,
        ...
        return (
            <View style={styles.container}>
                <Content style={{ width: '100%' }}>
                    <Text style={[styles.title, { marginTop: 20, textAlign: 'left', marginLeft: 30, }]}>Banking Details</Text>
                    <Text style={[styles.txtsub, { marginTop: 2, textAlign: 'left', marginLeft: 30, }]}>Account Type</Text>
                    ...
                    <Text style={[styles.txtsub, { marginTop: 20, textAlign: 'left', marginLeft: 30, }]}>Account Holder Name</Text>
                    <TextInput
                        style={{
                            borderRadius: 5,
                            borderWidth: 1,
                    ...
                    <Text style={[styles.txtsub, { marginTop: 20, textAlign: 'left', marginLeft: 30, }]}>Routing Number</Text>
                    <TextInput
                        style={{
                            borderRadius: 5,
                            borderWidth: 1,
                    ...
                    <Text style={[styles.txtsub, { marginTop: 20, textAlign: 'left', marginLeft: 30, }]}>Account Number</Text>
                    <TextInput
                        style={{
                            borderRadius: 5,
                            borderWidth: 1,
                    ...
                    <Text style={[styles.txtsub, { marginTop: 20, textAlign: 'left', marginLeft: 30, }]}>Confirm Account Number</Text>
                    <TextInput
                        style={{
                            borderRadius: 5,
                            borderWidth: 1,
                    ...
                    <Text style={[styles.txtsub, { marginTop: 20, textAlign: 'left', marginLeft: 30, }]}>Phone Number</Text>
                    <TextInput
                        style={{
                            borderRadius: 5,
                            borderWidth: 1,
