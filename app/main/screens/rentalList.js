  ...
  getImage = () => {
    ImagePicker.showImagePicker(options, (response) => {
      ...
      if (response.didCancel) {
        ...
        this.props.navigation.navigate('propertyCreate', { imagedata: source, category: this.state.category });
      }
    });
  }
    ...
    return (
      <View style={styles.container}>
        <Content style={styles.scrollContainer}>
          <LinearGradient colors={['#f71d3a', '#f71d3a']} style={styles.linearGradient1}>
          ...
          <View style={{ marginTop: 10 }}>
            ...
            >
              <View style={{ width: "50%", marginLeft: 0, marginTop: -25, }} >
                <Dropdown
              ...
              <View style={{ width: "50%", marginLeft: 5 }} >
                ...
                >
                  ...
                  <TextInput
                    style={[
                      styles.periodType,
                      { fontSize: 15, marginLeft: 5, color: '#f71d3a' }
                    ]}
                    placeholder="Search Ad's"
                    placeholderTextColor="#f71d3a"
          ...
          >
            ...
            <TextInput
              style={[
                styles.periodType,
                { fontSize: 15, marginLeft: 5, marginTop: 0, }
              ]}
